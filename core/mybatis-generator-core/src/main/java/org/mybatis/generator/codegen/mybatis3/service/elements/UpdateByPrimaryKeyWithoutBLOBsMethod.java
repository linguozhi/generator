 ...
 * @date: 2016/5/26
 */
public class UpdateByPrimaryKeyWithoutBLOBsMethod extends AbstractJavaServiceMethodGenerator {
    public UpdateByPrimaryKeyWithoutBLOBsMethod() {
        super();
    }
    ...
    public void addClassElements(TopLevelClass topLevelClass) {
        ...
        sb.append("return ").append(introspectedTable.getMyBatis3JavaMapperInstance())
                .append(".").append(introspectedTable.getUpdateByPrimaryKeyWithBLOBsStatementId())
