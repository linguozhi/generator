 ...
 * @date: 2016/5/26
 */
public class UpdateByPrimarKeySelectiveMethodGenerator extends AbstractJavaServiceMethodGenerator {
    public UpdateByPrimarKeySelectiveMethodGenerator() {
        super();
    }
    ...
    public void addClassElements(TopLevelClass topLevelClass) {
        ...
        sb.append("return ").append(introspectedTable.getMyBatis3JavaMapperInstance())
                .append(".").append(introspectedTable.getUpdateByPrimaryKeySelectiveStatementId())
