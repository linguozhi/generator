...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        addSelectTotalMethod(interfaze);
    ...
    /**
     * add by lingz at 20160525
     * @param interfaze
     */
    private void addSelectListMethod(Interface interfaze) {
     ...
     * @param interfaze
     */
    private void addSelectTotalMethod(Interface interfaze) {
        AbstractJavaMapperMethodGenerator methodGenerator = new SelectTotalMethodGenerator();
        initializeAndExecuteGenerator(methodGenerator, interfaze);
    }
